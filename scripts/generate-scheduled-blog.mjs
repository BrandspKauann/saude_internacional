...
})(window,document,'script','dataLayer','GTM-K6MCN9M2');</script>
<!-- End Google Tag Manager -->`;

const googleTagManagerBody = `<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K6MCN9M2"
