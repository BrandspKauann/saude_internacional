...
})(window,document,'script','dataLayer','GTM-TVG7QQS8');</script>
<!-- End Google Tag Manager -->`;

const googleTagManagerBody = `<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TVG7QQS8"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->`;

const hotjarTrackingCode = `<!-- Hotjar Tracking Code for saude -->
<script>
  (function(h,o,t,j,a,r){
      h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
      h._hjSettings={hjid:6782889,hjsv:6};
...
const header = (current = "") => `<!doctype html><html lang="pt-BR"><head>${googleTagManagerHead}
${hotjarTrackingCode}
<!-- Google tag (gtag.js) -->
